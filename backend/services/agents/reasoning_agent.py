        ...
        return [
            {
                ...
                "content": (
                    ...
                    "Notice that after cloning you are alrady inside the directory of the repo.\n"
                    ...
                    "- If you create, delete or modify files (e.g., GitHub Actions workflows, Dockerfiles, README, etc.), you MUST commit and push the changes. Use:\n"
