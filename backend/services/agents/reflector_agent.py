        ...
        return [
            {
                ...
                "content": (
                    ...
                    "- If the error message contains 'Repository directory does not exist', it means the repo hasn't been cloned yet.\n"
                    f"- In that case, suggest cloning it using:\n"
                    f"  git clone https://github.com/eugenius0/{repo_name}.git\n"
