        ...
        return [
            {
                ...
                "content": (
                    ...
                    "+ You are already inside the ./repos/{repo_name} directory after cloning."
                    "+ If unsure whether the file exists or what the repo contains, use `ls`, `ls -a`, or `git status` to check."
                    "+ If you are deleting, editing, or modifying files, always check for their presence first."
                    "+ Never use relative paths like `repos/...` or `cd ...` — assume you're already in the correct directory."
