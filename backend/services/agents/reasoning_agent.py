        ...
        return [
            {
                ...
                "content": (
                    ...
                    f"Notice that after cloning you are already inside the directory of the {repo_name}.\n"
                    ...
                    f"- The {task_description} is the task you need to accomplish.\n"
                    ...
                    "- If you run 'ls' and see the contents of the repository (e.g., .py files, README, workflows, etc.), assume you are already INSIDE the repo directory and DO NOT run 'cd' after that."
