        ...
        return [
            {
                ...
                "content": (
                    ...
                    f"+ If unsure whether the file exists or what the repo contains, use `ls`, `ls -a`, or `git status` to check"
                    f"- Only do actions if it is needed to fullfill the task:{task_description}."
