        ...
        return [
            {
                ...
                "content": (
                    ...
                    f"NEVER do cd {repo_name} — it is always wrong. You are already in the right directory: ./repos/{repo_name}. NEVER navigate into the repository directory.\n"
                    ...
                    f"- The current working directory is already './repos/{repo_name}'.\n"
                    ...
                    "- Do NOT assume you need to enter the repo folder again — if the repository contents are visible, you're already there."
                    ...
                    "- When using `cat <<EOF`, always open a block and write each line on a **separate line**, then close it with `EOF` on a line by itself. NEVER write the entire file content on the same line as the command.\n"
